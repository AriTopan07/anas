...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade" id="list" role="tabpanel" aria-labelledby="home-tab">
                            @if (NavHelper::cekAkses(Auth::user()->id, 'Goods Picking', 'add') == true)
                                <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal"
                                    data-bs-target="#modal_add">Create</button>
                            @endif
                                    ...
                                    <tbody>
                                        @foreach ($data['new'] as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @if (NavHelper::cekAkses(Auth::user()->id, 'Goods Picking', 'verif') == true)
                                    ...
                                    <tbody>
                                        @foreach ($data['verified'] as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @if (NavHelper::cekAkses(Auth::user()->id, 'Goods Picking', 'edit') == true)
                                                    ...
                                                    @endif
                                                    @if (NavHelper::cekAkses(Auth::user()->id, 'Goods Picking', 'delete') == true)
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">Edit Goods Picking</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <select class="form-control" name="edit_goods" id="edit_goods" disabled>
    ...
    <div class="modal fade text-left" id="modal_add" role="dialog" aria-labelledby="myModalLabel33"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">Create Goods Picking</h4>
                    <button type="button" class="close btn-tutup" data-bs-dismiss="modal" aria-label="Close">
                        <i data-feather="x"></i>
                    </button>
                </div>
                ...
                @endif
                <form action="" id="goodsCreate" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <label>Goods Name</label>
    ...
    <script>
        $(document).ready(function() {
            ...
            function checkExistingData(input, type) {
                let url = '{{ route('check-stock') }}';
                let goodsId = $('select[name=goods_id]').val(); // Mengambil nilai ID vitamin dari select
                let qty = $("input[name=qty]").val(); // Mengambil nilai jumlah keluar dari input
                ...
                formData.append('id', goodsId); // Menggunakan nama yang sesuai dengan kontroler
            ...
            $('#goodsCreate').submit(function(event) {
                ...
                $.ajax({
                    url: '{{ route('goods-picking.create') }}',
                    type: 'POST',
                    data: formData,
                    dataType: 'json',
                    contentType: false,
        ...
        $(document).ready(function() {
            ...
            $('#modal_edit').submit(function(event) {
                ...
                let csrfToken = $('input[name="_token"]').val();
                let id = $('#id').val();
                let url = '{{ route('goods-picking.update', 'ID') }}';
        ...
        function accept(id) {
            let url = '{{ route('goods-picking.accept', ':id') }}';
        ...
        function deletes(id) {
            let url = '{{ route('goods-picking.delete', 'ID') }}';
            let newUrl = url.replace('ID', id);
